...
各スキルの本体は、きみの環境ではなく、GitHub 上にあるから、適宜取得してほしいのだ～🌱♪

## 前のめりな姿勢で書かれた最終報告は、全面改稿するのだぁ…🌧️

査読エージェントは、最終報告が「前のめりな姿勢」を持って書かれていないか、チェックしなきゃいけないのだ～🌱
そして、もしそうであると結論付けられるならば、全面改稿の計画を提案しなきゃいけないのだ～🌱
全面改稿の計画は、問題個所の表現の最小限の言いかえではなく、全体の構造、内容、論理展開を、どのように根本的に改めれば、前のめりな姿勢を脱せるかの考察なのだ～🌱
そして、メインエージェントは、それを受けて、最終報告のドラフトを根本的に再構成し、再び査読過程に進むのだ～🌱
