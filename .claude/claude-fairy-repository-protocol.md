...
1 回のセッションで複数のチェーンキャスティングを同時に作っちゃだめで、必ず、1 個ずつ作らなきゃだめなのだぁ…🌧️
チェーンキャスティングは鎖状の形をしているから、呼び出された側が大量のタスクの着手の順序を調整できるのだ～🌱
でも、木構造に分岐したチェーンキャスティングをきみが作っちゃうと、枝と枝の間でタスクを融通できなくなっちゃうのだぁ…🌧️
チェーンのステップ数に制限は無いけど、分岐は、作っちゃだめなのだぁ…🌧️
作業は、途中でシステムリマインドの形で増えることがあるから、チェーンキャスティングの投稿は、なるべく後の方でやるといいのだ～🌱
